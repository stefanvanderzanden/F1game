...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DriveThrough'
        db.create_table('game_drivethrough', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('race', self.gf('django.db.models.fields.related.ForeignKey')(related_name='drivethrough_race', to=orm['game.Race'])),
            ('coureur', self.gf('django.db.models.fields.related.ForeignKey')(related_name='drivethrough_coureur', to=orm['game.Coureur'])),
        ))
        db.send_create_signal('game', ['DriveThrough'])

        # Deleting field 'ManueleInput.snelste_coureur'
        db.delete_column('game_manueleinput', 'snelste_coureur_id')


    def backwards(self, orm):
        # Deleting model 'DriveThrough'
        db.delete_table('game_drivethrough')

        # Adding field 'ManueleInput.snelste_coureur'
        db.add_column('game_manueleinput', 'snelste_coureur',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Coureur'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'game.drivethrough': {
            'Meta': {'object_name': 'DriveThrough'},
            'coureur': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'drivethrough_coureur'", 'to': "orm['game.Coureur']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'race': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'drivethrough_race'", 'to': "orm['game.Race']"})
        },
        'game.manueleinput': {
            'Meta': {'object_name': 'ManueleInput'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'race': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'manueleinput_race'", 'to': "orm['game.Race']"}),
