...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Race.is_aankomende_race'
        db.add_column('game_race', 'is_aankomende_race',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Race.is_aankomende_race'
        db.delete_column('game_race', 'is_aankomende_race')
